...
StewLang is a domain-specific language for creating and parsing recipe
instructions. The project consists of two main workspaces:
...
StewLang uses a parenthetical syntax for recipes. See `lang/parser/README.md`
for grammar details.
